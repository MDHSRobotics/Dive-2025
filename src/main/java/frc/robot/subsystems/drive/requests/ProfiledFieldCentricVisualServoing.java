...
public class ProfiledFieldCentricVisualServoing implements SwerveRequest {
     ...
     * @return this object
     */
    public ProfiledFieldCentricVisualServoing withRotationalDeadband(double newRotationalDeadband) {
     ...
     * @return this object
     */
    public ProfiledFieldCentricVisualServoing withRotationalDeadband(AngularVelocity newRotationalDeadband) {
